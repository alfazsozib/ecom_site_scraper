...
def data_scraper():  
    ...
    for pr_link in lns:
        ...
        for i in range(1,len(tds)):
            ...
            img_num = driver.find_element_by_xpath('/html/body/main/section[2]/div/div[2]/table/tbody/tr[2]/td[1]').text.replace('.','-')
            ...
            try:
                for im in img:
                    ...
                    if len(img) > 1:
                        urllib.request.urlretrieve(im_link,f"E:\projects\METALY\Images\{img_num}_{chr(97)}.jpg")
            except:
                pass            
